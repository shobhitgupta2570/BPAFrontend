...
const Item = ({id,photoUrl,title,description,time}) => (
  <View className="h-[130px] opacity-30">
      ...
      <View className="w-[78%] ml-[10%]">
        ...
        <View className=" w-[40%] h-8 z-20 mt-[2%]  flex-row  items-center  rounded-lg">
        <Image className="mr-[4%]" source={require("./../assets/images/Lock.png")}></Image>
        </View>
      </View>
      </View>
      </View>
  ...
  return (<>
    ...
    >
      ...
      />
        ...
        <Text className="text-white font-bold z-20 mt-[80%] text-xl mx-auto ">Why Bullying is Bad?</Text>
        <View className="flex-row z-20 mt-[2%] items-center mx-auto">
        <Text className="text-white ml-[2%] ">Lesson 4   </Text>
        <View className=" h-1 w-1 bg-white rounded-lg"></View>
        <Text className="text-white ml-[2%] "> 5 videos  </Text>
        <View className=" h-1 w-1 bg-white rounded-lg"></View>
        <Text className="text-white ml-[2%] "> 25 min watch </Text>
        </View>
        <View 
        className=" w-[80%] h-11  mt-[2%]  flex-row justify-center items-center mx-auto rounded-sm"
        style={{ position: 'absolute', top: '86%', left: '10%', right: 0, bottom: 0, backgroundColor: 'rgba(0, 0, 0, 0.5)' }}
        >
        {/* <Image className="mr-[4%]" source={require("./../assets/images/playButton.png")}></Image> */}
        <LockSVG width={15} height={15}/>
<Text className="text-white font-bold">    Gets Unlocked by your ARP teacher</Text>
        </View>
